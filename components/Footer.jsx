  ...
  useEffect(() => {
    const getData = async () => {
      const data = await fetch(
        "https://api.github.com/repos/amhousa/portfolio-v3"
      ).then((res) => res.json());
      setMetaData({
  ...
  return (
    <div className=" flex select-none text-sm  py-16 mt-16 flex-col h-max items-center mx-auto justify-center">
      ...
      <Link
        ...
        <Link
          href="https://github.com/amhousa?tab=repositories"
          target="blank"
          className=" dark:hover:text-purple-400 hover:text-purple-600 font-semibold"
        >
          {" "}
        ...
        <Link
          href="https://www.behance.net/amhousa"
          target="blank"
          className=" dark:hover:text-purple-400 hover:text-purple-600 font-semibold"
        >
          {" "}
      ...
      <a
        href="https://github.com/amhousa/portfolio-v3"
        target="blank"
        rel="noreferrer"
